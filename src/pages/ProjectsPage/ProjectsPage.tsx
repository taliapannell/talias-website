...
const projects: Project[] = [
  {
  ...
  },
   {
    ...
    description: "The Document Ingestion project is a robust, end-to-end GenAI-powered pipeline that enables seamless uploading, parsing, embedding, and storage of documents using Azure-native services and large language models, empowering downstream applications—such as intelligent search, chatbots, and compliance tools—with fast, scalable, and secure access to structured knowledge extracted from unstructured content.",
    imageUrl: documentIngestionImage
  }, {
    id: 5,
    title: "Maximo Analytics",
    description: "The Maximo Analytics project is a forward-looking initiative that leverages predictive analytics, operational data, and environmental inputs to proactively identify equipment failures and optimize maintenance strategies, combining IBM’s Maximo Application Suite with custom-built dashboards and AI-powered insights to deliver real-time asset performance monitoring, reduce operational costs, and enhance decision-making across asset-intensive industries through a unified, cloud-enabled, and user-centric platform.",
...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, onClick, flipped }) => {
  return (
    <Card 
